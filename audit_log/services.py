...
class AuditLogApiService(AuditLogServiceBase):
    ...
    def get_audit_logged_object_ids(self, request) -> List[str]:
        """
    ...
    def get_operation_name(self, request) -> str:
        """
        Determine the operation name based on the request method.
    ...
    def get_actor_data(self, request) -> AuditActorData:
        """
    ...
    def get_target(self, request) -> AuditTarget:
        """
    ...
    def is_audit_logging_endpoint(self, request) -> bool:
        """
    ...
    def get_response_status(self, response) -> Optional[str]:
        """
    ...
    def create_commit_message(self, request, response) -> AuditCommitMessage:
        """
    ...
    def commit_to_audit_log(self, request, response) -> None:
        """
    ...
    def delete_audit_logged_object_ids(self, request) -> None:
        """
    ...
    def add_audit_logged_object_ids(self, request, instances) -> None:
        """
